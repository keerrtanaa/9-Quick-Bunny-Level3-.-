...
function setup() {
  ...
  bgImage = createSprite(600, 600);
  bgImage.addImage(backgroundImage);

  carrot = createSprite(300, 300);
  carrot.scale = 2.5;
  ...
  obs2 = createSprite(400, 200, 50, 30);
  obs2.velocityX = 4;

  obs3 = createSprite(300, 120, 50, 30);
  obs3.velocityX = -2;

  obs4 = createSprite(200, 130, 30, 30);
  obs4.velocityX = 5;

  obs5 = createSprite(200, 140, 90, 30);
  obs5.velocityX = 3;

  obs6 = createSprite(120, 300, 40, 30);
  obs6.velocityX = -3;

  obs7 = createSprite(220, 200, 60, 30);
  obs7.velocityY = -3;

  obs8 = createSprite(230, 300, 50, 30);
  obs8.velocityY = -5;
